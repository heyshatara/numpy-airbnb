...
st.title("Amsterdam AirBnb Proximity Analysis")
st.markdown("Here's the dataframe created to showcase the Amsterdam AirBnB listings by the distance away from our top tourist stop: De Gooyer Windmill.")
